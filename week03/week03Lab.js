...
// Step 6
console.log(array1[array1.length - 1]);
console.log("Yes it changed from earlier in this exercise");
console.log("Yes I can retrieve the last element that was just added");
...
let myTodoList = [];
// Step 2
myTodoList.push("Buy milk");
myTodoList.push("Make dinner");
myTodoList.push("Fold laundry");
console.log(myTodoList);
// Step 3
myTodoList.splice(1, 1);
console.log(myTodoList);
// Step 4
const yourTodoList = ["Wash Dishes", "Mow lawn"];
...
//ourTodoList = []; // clear array if needed
...
// with reduce method mult line multi function
/* function addingMachine(x) {
      return x.reduce(sumNum, 0);
}
function sumNum(acc, val) {
       return acc + val;
} */

// with reduce method single line
function addingMachine(x) {
